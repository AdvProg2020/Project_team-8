        ...
        try {
            ...
            if(Good.isGoodWithName(nameText))
                ...
                if (good == null) {
                    ...
                    new Request(Request.type.EDIT_GOOD).createEditProductRequest(new Good(good.getName(), brandText, priceText, good.getSeller(), stockText, categoryValue, detailText, photoUrl,getProperties()));
                }
