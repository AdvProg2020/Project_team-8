...
public class ManagerProfileController implements Initializable {
    ...
    public void editing(ActionEvent actionEvent) {
        ...
        if (usernameText.length() == 0 || passwordText.length() == 0 ||
            ...
            UserHandler.currentManager.setUsername(usernameText);
            UserHandler.currentManager.setPassword(passwordText);
            UserHandler.currentManager.setFirstName(firstNameText);
            UserHandler.currentManager.setLastName(lastNameText);
            UserHandler.currentManager.setEmail(emailText);
            UserHandler.currentManager.setPhoneNumber(phoneNumberText);
        }
    }
