...
public class RegisterMenuController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        type.getItems().addAll("Buyer", "Seller");
    }
    ...
    public void registering(ActionEvent actionEvent) {
        ...
        String typeValue = type.getValue().toString();
        ...
        if (usernameText.length() == 0 || passwordText.length() == 0 ||
            ...
            if (typeValue.equals("Buyer")) {
                new Buyer(usernameText, firstNameText, lastNameText, emailText, phoneNumberText, passwordText);
            }
            else {
//                new Seller(usernameText, firstNameText, lastNameText, emailText, phoneNumberText, passwordText, )
            }
        }
    }
